...
def create_model():
    ...
    # set targets
    X = data_df[['Open', 'High', 'Low', 'Close', 'Adj Close', 'Volume', 'SMA_50', 'SMA_200', 'RSI', 'CCI', 'Momentum', 'EMA_50', 'Low_lag_5', 'High_lag_5', 'Open_Rolling_10', 'Low_Rolling_10', 'Rolling_Avg_Diff_10']]
    y = data_df['NextClose']
    ...
    model = GradientBoostingRegressor(n_estimators=200, learning_rate=0.05, min_samples_split=4, min_samples_leaf=1, max_depth=3) # Hypertuned
    ...
    joblib.dump(model, './mining_models/model_gb.pkl')
