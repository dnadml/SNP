...
from model_test_get_data import prep_data
...
def create_models():
    ...
    for interval, data_df in data_dfs.items():
        ...
        joblib.dump(model, f'C:/Users/mason/Local_Model/snpOracle/SNP/model_gb_{interval}.pkl')
        joblib.dump(scaler, f'C:/Users/mason/Local_Model/snpOracle/SNP/scaler_gb_{interval}.pkl')
